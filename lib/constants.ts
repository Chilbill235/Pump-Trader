...
export const PUBLIC_RPC_WARNING =
  "Public mainnet RPC is rate-limited. Get a free Helius key at helius.dev and set NEXT_PUBLIC_SOLANA_RPC_URL in .env.local, or set a custom RPC in Settings.";
